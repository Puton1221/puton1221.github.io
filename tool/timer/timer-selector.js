...
function getMessage(language, messageKey) {
  var translations = {
    ...
    //日本語
    'ja': {
      'timer-description': '期限:',
      'timer-progress': '残り時間:',
      'timer-finished': '経過時間:',
      'timer-type': 'タイマーの種類:',
      'timer-type-generic': 'その他一般',
      'timer-type-deletion': '削除猶予',
      'timer-type-ban': 'Ban期間',
      'duration': '期間',
      'duration-1d': '1日',
      'duration-1w': '1週間',
      'duration-2w': '2週間',
      ...
      'start-time-later': '後で',
      'messages': 'メッセージ',
      'message-progress': '進行中のタイマー (任意)',
      'message-finished': '終了したタイマー (任意)',
      'advanced-section': '高度な設定',
      'height': 'Height',
      'width': 'Width',
      ...
      'message-ban-progress': 'BAN期間終了まで残り:',
      'message-ban-finished': 'BAN解除からの経過時間:',
      'build-timer': 'タイマーを作成する',
      'info-help': 'ヘルプ',
      'info-source': 'ソース',
      'error-missing': '各セクションを選択をしてください。',
      'error-invalid': '無効です。バグレポートを提出してください。',
    },
  };
